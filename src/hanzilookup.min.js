...
HanziLookup.data = {};
HanziLookup.data["mmah"] = require('./mmah.json')
HanziLookup.data["mmah"].substrokes = HanziLookup.decodeCompact(HanziLookup.data["mmah"].substrokes);
HanziLookup.data["orig"] = require('./orig.json')
HanziLookup.data["orig"].substrokes = HanziLookup.decodeCompact(HanziLookup.data["orig"].substrokes);
